                ...
                <div className='px-4 py-1'>
                    <div className='flex items-center justify-between'>
                        ...
                        <div className='flex space-x-4'>
                            <Button className='bg-blue-500 hover:bg-blue-500 '>Enroll Now</Button>
                        </div>
                    </div>
                </div>
                    ...
                    courseLecture?.length == 0 ? null : <div className='flex flex-col md:flex-row justify-between gap-10 p-6'>
                        ...
                        <Card>
                            <CardContent className='p-4 flex flex-col'>
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipise elit. Non quisquam esse 
                                reprehe eos, ipsum minima molestiae ullam saepe placeat cumque!</p>
                            </CardContent>
