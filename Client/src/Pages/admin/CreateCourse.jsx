...
const CreateCourse = () => {
    ...
    return (
        <div className='p-10 md:pr-20 h-screen'>
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium rem soluta, blanditiis ab veritatis eaque. Laudantium excepturi illum?</p>
            <div className='mt-10'>
                <div>
                    <Label>Title</Label>
                    <Input 
                ...
                <div className='flex gap-2'>
                    <Button onClick={()=>navigate('/admin/course')} className="bg-white text-black hover:bg-slate-50" >Cancel</Button>
