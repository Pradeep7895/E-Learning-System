...
const CreateLecture = () => {
    ...
    useEffect(()=>{
        ...
        getLectures()
    },[dispatch, lecture, params.courseId])
    return (
        <div className='p-4 md:p-10 md:pr-20 h-screen'>
            ...
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Tempore, iste veritatis? Veritatis labore ipsam aut Lorem ipsum dolor sit.!</p>
            <div className='mt-10 space-y-5'>
                <div>
                    <Label>Title</Label>
                    <Input type="text" placeholder="Your Lecture Name" className="bg-white" value={lectureTitle} onChange={(e)=>
                    setLectureTitle(e.target.value)} />
                </div>
                <div className='flex gap-2'>
                    <Button onClick={()=>navigate(`/admin/course/${params.courseId}`)} className="bg-white text-black hover:bg-white">Back to Course</Button>
