        ...
        <Card className="bg-gray-100">
            <CardHeader className="flex justify-between ">
                ...
                <div className='space-x-2'>
                    ...
                    className="bg-gray-800 hover:bg-gray-800">{selectedCourse.isPublished ? "UnPublish": "Publish"}</Button>
            ...
            <CardContent>
                <div className='mt-5'>
                    ...
                    <div className='flex md:flex-row flex-wrap gap-5 items-center md:gap-5 '>
                        <div className=' mt-5'>
